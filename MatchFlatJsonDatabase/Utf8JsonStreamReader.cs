...
namespace Utf8JsonStreamReader
{
	...
	// Jvs: this is from https://github.com/evil-dr-nick/utf8jsonstreamreader , had to remove nullability and the span stuff
	internal ref struct Utf8JsonStreamReader
	{
		...
		private void MoveNext()
		{
			...
			do
			{
				...
				var splice = span.ToArray();
				splice.CopyTo( span );

				bytesRead = _stream.Read( splice , 0 , splice.Length );
